...
# define TOLERANCE_MIN  1                       // minimum level of the Toleance parameter
# define DETAIL_MAX     255                     // Maximum level of the Detail parameter
# define DETAIL_MIN     0                       // Minimum level of the Detail parameter
# define STEP_TOLERANCE 10                      // Changing Tolerance value Step in Graphical Interface
# define STEP_DETAIL    16                      // Changing Setail value Step in Graphical Interface
...
tile_colour_t       msx_tile_colour[TILES_NUM_TABLE][TILES_MAX_TABLE];
...
const char* Palette_name[] = { "MSX Palette 0",
    "MSX Palette 1",
    "C64 Palette",
    "SPECTRUM Palette",
    "GAME BOY Palette",
...
//float  calcdist2000(float r1, float g1, float b1, float r2, float g2, float b2);
